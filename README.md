<!--
  ...
  ※ 소개/마케팅 문구는 랜딩 페이지 카피를 그대로만 쓴다. 별도 문구를 새로 짓지 않는다.
-->
...
소개·데모: <https://greyfolk99.github.io/myeonggyeong/>
...
`SKILL.md` 와 `reference/interpretation-guide.md` 를 그대로 따릅니다. 시트에 없는 항목을 있다고 하지 않습니다.
...
*엔진(fate_py)은 사주 계산 엔진 fate-js 의 순수 파이썬 1:1 포팅본으로, 동일 입력 20,000+건 대조로 결과 일치를 검증했습니다.*
